...
def main():
    ...
    parser.add_argument("--data_dir",
                        default="data_process/data/snli",
                        type=str,
    ...
    if args.do_train:
        if args.do_dev:
            train_features = processor.get_dev_features(args.data_dir)
        else:
    ...
    config = PASentConfig(bert_model_path=args.bert_model_path, bert_model_type=args.bert_type,chunk_encoder=args.chunk_encoder,
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
                ...
                if task_name == 'mnli':
                    ...
                    test_features = processor.get_dev_features(args.data_dir)
